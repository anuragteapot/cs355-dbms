...
--
-- 1
select * from Author_details as ad
  LEFT JOIN Student_details as sd ON ad.author_id = sd.student_id
  WHERE sd.student_id is NULL;

  select * from Student_details as sd
    RIGHT JOIN Author_details as ad ON ad.author_id = sd.student_id
    WHERE sd.student_id is NULL;

    select * from Student_details as sd
      JOIN Author_details as ad ON ad.author_id = sd.student_id;  
